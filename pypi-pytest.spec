...
Source0  : https://files.pythonhosted.org/packages/b4/8c/9862305bdcd6020bc7b45b1b5e7397a6caf1a33d3025b9a003b39075ffb2/pytest-8.3.2.tar.gz
...
%prep
%setup -q -n pytest-8.3.2
cd %{_builddir}/pytest-8.3.2
pushd ..
cp -a pytest-8.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724423870

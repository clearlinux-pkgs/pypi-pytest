...
Source0  : https://files.pythonhosted.org/packages/05/35/30e0d83068951d90a01852cb1cef56e5d8a09d20c7f511634cc2f7e0372a/pytest-8.3.4.tar.gz
...
%prep
%setup -q -n pytest-8.3.4
cd %{_builddir}/pytest-8.3.4
pushd ..
cp -a pytest-8.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733165181

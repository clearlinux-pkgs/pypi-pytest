...
Source0  : https://files.pythonhosted.org/packages/80/1f/9d8e98e4133ffb16c90f3b405c43e38d3abb715bb5d7a63a5a684f7e46a3/pytest-7.4.4.tar.gz
...
%prep
%setup -q -n pytest-7.4.4
cd %{_builddir}/pytest-7.4.4
pushd ..
cp -a pytest-7.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704141666

...
Source0  : https://files.pythonhosted.org/packages/e5/6c/f3a15217ac72912c28c5d7a7a8e87ff6d6475c9530595ae9f0f8dedd8dd8/pytest-7.2.1.tar.gz
...
%prep
%setup -q -n pytest-7.2.1
cd %{_builddir}/pytest-7.2.1
pushd ..
cp -a pytest-7.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673892322

...
Source0  : https://files.pythonhosted.org/packages/b9/29/311895d9cd3f003dd58e8fdea36dd895ba2da5c0c90601836f7de79f76fe/pytest-7.2.2.tar.gz
...
%prep
%setup -q -n pytest-7.2.2
cd %{_builddir}/pytest-7.2.2
pushd ..
cp -a pytest-7.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677976577

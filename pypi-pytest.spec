...
Source0  : https://files.pythonhosted.org/packages/ae/3c/c9d525a414d506893f0cd8a8d0de7706446213181570cdbd766691164e40/pytest-8.3.5.tar.gz
...
%prep
%setup -q -n pytest-8.3.5
cd %{_builddir}/pytest-8.3.5
pushd ..
cp -a pytest-8.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742460807

...
Source0  : https://files.pythonhosted.org/packages/38/d4/174f020da50c5afe9f5963ad0fc5b56a4287e3586e3de5b3c8bce9c547b4/pytest-7.4.3.tar.gz
...
%prep
%setup -q -n pytest-7.4.3
cd %{_builddir}/pytest-7.4.3
pushd ..
cp -a pytest-7.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698185911
